...
class DatabaseHelper {
  ...
  static final table = 'UsersChats1';
  ...
  static final columnEthnicity = 'ethnicity';
  static final columnHeight = 'height';
  static final columnBio = 'bio';

  static final columnBodyType = 'bodyType';
  static final columnGender = 'gender';
  static final columnInterestedIn = 'interestedIn';
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute('''
          CREATE TABLE $table (
            ...
            $columnAge TEXT,
            $columnHeight TEXT,
            $columnEthnicity TEXT,


            $columnInterests TEXT,
            $columnInterestedIn TEXT,
  ...
  Future<int> insert(Map<String, dynamic> row) async {
    // print("Here is we gonna print 111111111" + row.toString());
